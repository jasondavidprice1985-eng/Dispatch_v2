...
const getState       = ()  => ({ ...state, filters: { ...state.filters } });
const getDeliveries  = ()  => state.deliveries;
const getFiltered    = ()  => state.filtered;
const getIndexes     = ()  => state.indexes;
const getCMLookup    = ()  => state.cmLookup;
const getFilters     = ()  => ({ ...state.filters });
const getActiveCM    = ()  => state.filters.cm;
const getActiveCMName = () => state.cmLookup[state.filters.cm] ?? state.filters.cm ?? 'Everyone';
const isLoading      = ()  => state.loading;
const isReady        = ()  => state.ready;
const getError       = ()  => state.error;
const getFilename    = ()  => state.filename;
const getLoadedAt    = ()  => state.loadedAt;
